...
public class class223 extends class204 {
   ...
   class223(Stream var1) {
      var1.field2339 = var1.field2338.length - 3;
      ...
      Stream var51 = new Stream(this.field2546);
      ...
      for(int var60 = 0; var60 < var2; var60++) {
         ...
         while(true) {
            while(true) {
               int var63 = var1.method3566(-394457827);
               var51.method3688(var63);
               int var64 = var1.field2338[var29++] & 255;
               ...
               if(var64 == 7) {
                  ...
                  var51.writeByte(47);
                  var51.writeByte(0);
                  var51.method3543(var51.field2339 - var61, -1356616575);
                  continue label230;
               }
               ...
               if(var64 == 23) {
                  ...
                  var51.writeByte(81);
                  var51.writeByte(3);
                  var51.writeByte(var1.field2338[var50++]);
                  var51.writeByte(var1.field2338[var50++]);
                  var51.writeByte(var1.field2338[var50++]);
               } else {
                  var52 ^= var64 >> 4;
                  if(var62 == 0) {
                     ...
                     var53 += var1.field2338[var37++];
                     var54 += var1.field2338[var38++];
                     ...
                     var28 = var28 + var1.field2338[var15++] & 127;
                     var51.writeByte(var28);
                     byte var66;
                     if(var28 != 0 && var28 != 32) {
                        if(var28 == 1) {
                           var66 = var1.field2338[var34++];
                        } else if(var28 == 33) {
                           var66 = var1.field2338[var41++];
                        } else if(var28 == 7) {
                           var66 = var1.field2338[var35++];
                        } else if(var28 == 39) {
                           var66 = var1.field2338[var42++];
                        } else if(var28 == 10) {
                           var66 = var1.field2338[var36++];
                        } else if(var28 == 42) {
                           var66 = var1.field2338[var43++];
                        } else if(var28 == 99) {
                           var66 = var1.field2338[var46++];
                        } else if(var28 == 98) {
                           var66 = var1.field2338[var47++];
                        } else if(var28 == 101) {
                           var66 = var1.field2338[var48++];
                        } else if(var28 == 100) {
                           var66 = var1.field2338[var49++];
                        } else if(var28 != 64 && var28 != 65 && var28 != 120 && var28 != 121 && var28 != 123) {
                           var66 = var1.field2338[var39++];
                        } else {
                           var66 = var1.field2338[var30++];
                        }
                     } else {
                        var66 = var1.field2338[var44++];
                     }
                     ...
                     var56 += var1.field2338[var45++];
                     var56 += var1.field2338[var33++] << 7;
                     ...
                     var51.writeByte(var1.field2338[var44++]);
                  }
               }
            }
         }
               ...
               while(var7 == var4.field2525[var6]) {
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        class213 var14 = (class213)this.field2547.get((long)var13);
                        if(var14 == null) {
   ...
   static class223 method4415(class247 var0, int var1, int var2) {
      byte[] var3 = var0.method4625(var1, var2, 1550511859);
      return var3 == null ? null : new class223(new Stream(var3));
   }
}
