...
public final class PacketBuilder implements KeyListener, FocusListener {
    public static PacketBuilder packetBuilder = new PacketBuilder();
    public static int keyCodeIndex = 0;
    ...
    public static int[] keysPressed = new int[128];
    ...
    public final synchronized void keyPressed(KeyEvent keyEvent) {
        if (packetBuilder != null) {
            ...
            if (keyCode >= 0 && keyCode < field334.length) {
                keyCode = field334[keyCode];
                if ((keyCode & 128) != 0) {
                    keyCode = -1;
                }
            } else {
            ...
            if (keyCodeIndex >= 0 && keyCode >= 0) {
                keysPressed[keyCodeIndex] = keyCode;
                keyCodeIndex = keyCodeIndex + 1 & 127;
                if (field344 == keyCodeIndex) {
                    keyCodeIndex = -1;
                }
            }
            ...
            if (keyCode >= 0) {
                var3 = field351 + 1 & 127;
                if (var3 != field350) {
                    field348[field351] = keyCode;
                    field346[field351] = 0;
                    field351 = var3;
                }
            }

            var3 = keyEvent.getModifiers();
    ...
    public final synchronized void keyReleased(KeyEvent keyEvent) {
        if (packetBuilder != null) {
            ...
            if (keyCodeIndex >= 0 && var2 >= 0) {
                keysPressed[keyCodeIndex] = ~var2;
                keyCodeIndex = keyCodeIndex + 1 & 127;
                if (keyCodeIndex == field344) {
                    keyCodeIndex = -1;
                }
            }
        }
    ...
    static final class197 method691(Stream stream, class197 var1) {
        ...
        for (var4 = 0; var4 < var3; var4++) {
            boolean var5 = stream.readUByte() == 1;
            int var6 = stream.readMedium();
            Object var7;
            if (var5) {
                var7 = new class195(stream.readString());
            } else {
                var7 = new class211(stream.readInt());
            }
    ...
    static void buildPacket(int var0, int var1, int var2, int var3, String var5, int var6, int var7, byte var8) {
        if (var2 >= 2000) {
            var2 -= 2000;
        }
        ...
        if (var2 == 8) {
            ...
            if (var14 != null) {
                ...
                GameClient.field626.method1980(var10);
            }
        }
        ...
        if (var2 == 38) {
            ...
            if (var2 == 57 || var2 == 1007) {
                ...
                if(var1 == 17104918) {
                    // Fixed Client
                    Loader.frame.setResizable(false);
                    Loader.frame.setSize(781, 541);
                } else if(var1 == 17104919) {
                    // Resizable Client
