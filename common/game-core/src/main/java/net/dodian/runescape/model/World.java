...
import net.dodian.runescape.model.map.Flags;
...
import net.dodian.runescape.util.EquipmentInfo;
...
public class World {
    ...
    private long worldStartup = System.currentTimeMillis();
    ...
    public void loadEquipmentInfo() {
        equipmentInfo = new EquipmentInfo(
                new File("../game-data/list/equipment_info.json"),
                new File("../game-data/list/renderpairs.txt"),
                new File("../game-data/list/bonuses.json"),
                new File("../game-data/list/weapon_types.txt"),
                new File("../game-data/list/weapon_speeds.txt"));
    }
