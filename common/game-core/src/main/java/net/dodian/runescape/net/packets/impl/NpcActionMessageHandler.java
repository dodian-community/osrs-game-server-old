...
import net.dodian.runescape.net.packets.models.npc.NpcAction1;
import net.dodian.runescape.net.packets.models.npc.NpcAction2;
import net.dodian.runescape.net.packets.models.npc.NpcAttack;
