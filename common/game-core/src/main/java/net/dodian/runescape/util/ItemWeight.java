...
import net.dodian.runescape.net.message.game.command.SetWeight;
...
public class ItemWeight {
	...
	public static void init() {
		...
		try (BufferedReader reader = new BufferedReader(new FileReader("../game-data/list/item_weight.txt"))) {
			while (true) {
