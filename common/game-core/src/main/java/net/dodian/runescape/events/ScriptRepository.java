package net.dodian.runescape.events;
...
public class ScriptRepository {
    ...
    public void load() {
        ...
        Set<Method> methods = new Reflections("net.dodian.runescape.content", new SubTypesScanner(false), new MethodAnnotationsScanner()).getMethodsAnnotatedWith(ScriptMain.class);
        methods.forEach(m -> {
