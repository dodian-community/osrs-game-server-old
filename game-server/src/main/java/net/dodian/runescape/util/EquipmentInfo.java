...
import net.dodian.runescape.model.entity.player.EquipSlot;
import net.dodian.runescape.model.entity.player.WeaponType;
...
public class EquipmentInfo {
	...
	public EquipmentInfo(File equipmentDefinitions, File renderPairs, File bonuses, File weaponTypes, File weaponSpeeds) {
		...
		loadEquipmentRequirements(new File("../game-data/list/requirements.txt"));
	}
