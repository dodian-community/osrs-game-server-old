...
object MultiwayCombat {
	...
	val exclusions = arrayOf(
			...
			Area(3236, 10229, 3248, 10236), Area(3193, 10051, 3207, 10061)
	)
	...
	@JvmStatic fun includes(tile: Tile): Boolean {
		return !exclusion(tile) && (REGIONS.any { id -> id == tile.region() } || CHUNKS.any { id -> tile.chunk() == id || tile == Tile(3021, 3855) || tile == Tile(3022, 3855) })
	}
